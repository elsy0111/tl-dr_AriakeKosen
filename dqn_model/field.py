...
ID_LIST=('A11','A13','A15','A17','A21','A25','B11','B13','B15','B17','B21','B25','C11','C13','C15','C17','C21','C25')
...
def field_index(id):
    ...
    return width,height,ike,shiro,first_shokunin,second_shokunin

def generate_field(id,turn=200,coef=(10,30,100)):
    width,height,ike,shiro,first_shokunin,second_shokunin=field_index(id)
    return state.State(width,height,ike,shiro,first_shokunin,second_shokunin,turn,coef)
